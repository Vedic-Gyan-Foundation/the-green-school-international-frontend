      ...
      <div className={styles.container}>
        ...
        <div className={styles.body}>
          ...
          <p>
            ...
            have the same meaning whether they appear in singular or plural
            form.
          </p>
          ...
          <ul className={styles.list}>
            ...
            <li>
              ...
              or is under common control with a party. &ldquo;Control&rdquo;
              means ownership of 50% or more of the shares, equity interest, or
              other securities entitled to vote for the election of directors
              or other managing authority.
            </li>
            <li>
              <b>Company</b> (referred to as &ldquo;the Company&rdquo;,
            ...
            <li>
              ...
              your browsing history and other uses.
            </li>
            <li>
            ...
            <li>
              ...
              or the company or other legal entity on whose behalf the
          ...
          <p>
            ...
            include beacons, tags, and scripts to collect and analyze
          ...
          <p>
            The Company may use personal data for several purposes including
            ...
            offers, and to manage your requests, as described in the full
            policy.
          </p>
          ...
          <p>
            ...
            personal data that we have collected about you. You may update,
          ...
          <p>
            ...
            directed to that site. We strongly advise you to review the Privacy
          ...
          <p>
            ...
            <a className={styles.link} href="https://greenschoolguwahati.com/contact">
