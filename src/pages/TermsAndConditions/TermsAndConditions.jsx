  ...
  return (
    <>
      ...
      <div className={styles.terms_container}>
        <h1 className="font-bold text-3xl text-center">Terms and Conditions</h1>
        ...
        <section className={styles.terms_section}>
          ...
          <h4 className="font-medium text-xl underline">Interpretation</h4>
          <p>
          ...
          <h4 className="font-medium text-xl underline">Definitions</h4>
        ...
        <section className={styles.terms_section}>
          ...
          <h4 className="font-medium text-base underline">Severability</h4>
          <p>
          ...
          <h4 className="font-medium text-base underline">Waiver</h4>
          <p>
