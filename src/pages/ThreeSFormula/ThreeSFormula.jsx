        ...
        <div className={styles.cards}>
          ...
          <div className={styles.card} id="sanskar">
            ...
            <div className={styles.card_desc}>
              ...
              <p className={styles.card_text}>
                Sanskar, cultural values, and ethical principles serve as a
                vital moral compass for intelligence. They provide the ethical
                foundation essential for responsible decision-making. Without
                these guiding principles, intelligence may lead to actions
                lacking ethical considerations, posing potential harm.
                Integrating Sanskar with intelligence ensures a holistic and
                responsible approach to life&apos;s complexities.
              </p>
            </div>
            <div></div>
          </div>
          ...
          <div className={styles.card} id="sustainibility">
            ...
            <div className={styles.card_desc}>
              ...
              <p className={styles.card_text}>
                Integrating sustainability into the curriculum is vital for
                fostering responsible citizenship. Emphasizing critical
                thinking, the curriculum equips students to address global
                challenges and make ethical decisions, embracing the 3 R
                concept—Reduce, Reuse, Recycle. Beyond academic knowledge, it
                instills values for reducing waste, ensuring students actively
                contribute to a more environmentally conscious and
                interconnected world, ready to implement these principles in
                their daily lives.
              </p>
            </div>
            <div></div>
