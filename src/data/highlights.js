...
export const highlights = [
  {
    ...
    fulldesc:
      "Vedic Maths, derived from ancient Indian scriptures known as the Vedas, offers a simple yet powerful approach to mathematical problem-solving. With its emphasis on speed, versatility, and flexibility, Vedic Maths techniques, enable rapid mental calculations across various mathematical operations. By enhancing mental agility, boosting confidence, and saving time, Vedic Maths not only enriches mathematical proficiency but also fosters holistic learning by integrating ancient wisdom with modern education, making it an invaluable resource for learners of all ages.",
    icon: icon1,
  },
  {
    title: "Yoga",
