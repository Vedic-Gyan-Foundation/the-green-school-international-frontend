    ...
    <>
        ...
        <div className={styles.footer_container}>
          ...
          <div className={styles.footer_links}>
            ...
            <ul>
              <li>
                {" "}
                <Link to={"/"} className={styles.footer_navlink}>
                  Home
                </Link>
              </li>
              <li>
                {" "}
                <Link to={"/about"} className={styles.footer_navlink}>
                  Our School
                </Link>
              </li>
              <li>
                {" "}
                <Link to={"/threesformula"} className={styles.footer_navlink}>
                  3S Formula
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link to={"/admission"} className={styles.footer_navlink}>
                  Admissions
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link to={"/blogs"} className={styles.footer_navlink}>
                  Blogs
                </Link>
              </li>
              <li>
      ...
      <div className={styles.copyright}>
        <p className={styles.copyright_text}>
          Copyright© 2024 | All Rights Reserved. Designed & Developed by Vedic
          Gyan Foundation.
        </p>
      </div>
    </>
