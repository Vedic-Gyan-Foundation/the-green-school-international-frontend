const Button = ({ clickHandler, children, variant = "primary", className = "", ...rest }) => {
  const base =
  ...
  const variants = {
    ...
    sun:
      "bg-gradient-to-br from-sun-300 to-sun-500 text-brand-900 shadow-[0_10px_25px_-10px_rgba(234,190,97,0.7)] hover:shadow-[0_18px_35px_-10px_rgba(234,190,97,0.85)] hover:-translate-y-0.5",
    brand:
