    ...
    >
      <div className={styles.why_choose_us_img}>
        <div className={styles.image_frame}>
          <img src={homeaboutimg} alt="Students at The Green School" loading="lazy" />
        </div>
      ...
      <div className={styles.why_choose_us_desc}>
        ...
        <p className={styles.lead}>
          At The Green School International, we prioritize holistic education
          to nurture compassionate, empathetic, and environmentally conscious
          global citizens.
        </p>
